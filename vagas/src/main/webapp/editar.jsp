...
<body class="container">
  ...
  <header>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link" href="edicao.html">EdiÃ§Ã£o</a>
          </div>
        </div>
      </div>
    </nav>
    ...
    <p></p>
      <button type="button" class="btn btn-primary">Ver Opções</button>
    <p></p>
    ...
    <div class="row">
        <div class="col-5">
          <div></div>
            <label for="descricao_do_cargo" class="form-label" >Descrição do Cargo</label>
    ...
    <div class="row">
      <div class="col-5">
        <div></div>
          <label for="requisitos_obrigatorios" class="form-label" >Requisitos Obrigatórios</label>
  ...
  <div class="row">
      <div class="col-5">
        <div></div>
          <label for="requisitos_desejaveis" class="form-label" >Requisitos Desejáveis</label>
  ...
  <div class="row">
    <div class="col-5">
      <label for="remuneracao_mensal" class="form-label">Remuneração Mensal</label>
